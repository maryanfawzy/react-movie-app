...
const Header = () => {
    ...
    return (
          ...
          <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 dark:border-b-2 dark:border-gray-900">
          ...
          <div id='nav-links' className={`items-center justify-between ${hidden ?"hidden ":""} w-full md:flex md:w-auto md:order-1" id="navbar-search`}>
            ...
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <NavLink to="/" className={({isActiveClass}) =>isActiveClass ? activeClass : inActiveClass} end>Home</NavLink>
              </li>
              <li>
                <NavLink to="/movies/popular" className={({isActiveClass}) =>isActiveClass ? activeClass : inActiveClass}>Popular</NavLink>
              </li>
              <li>
                <NavLink to ="/movies/top" className={({isActiveClass}) =>isActiveClass ? activeClass : inActiveClass}>Top Rated</NavLink>
              </li>
              <li>
                <NavLink to ="/movies/upcomming" className={({isActiveClass}) =>isActiveClass ? activeClass : inActiveClass}>Up Commming</NavLink>
              </li>
            </ul>
          </div>
          </div>
